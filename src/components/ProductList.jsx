...
const ProductList = () => {
  ...
  const handleFavorite = (id, e) => {
    ...
    setFavorites(prev => ({
      ...prev,
      [id]: !prev[id]  // Toggle the favorite status for the specific product id
    }));
  };
  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <h2 className="text-2xl font-bold tracking-tight text-gray-900">O que está em alta</h2>
            ...
            <div key={product.id} className="group relative">
              <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                  ...
                  <IconButton
                    className={"py-4 px-4"}
                    icon={favorites[product.id] ? AiFillHeart : AiOutlineHeart}
